...
(function ($) {
    ...
    Tipsy.prototype = {
        show: function () {
            ...
            if (title != undefined && title != "undefined" && this.enabled) {
                var $tip = this.tip();
        ...
        tip: function () {
            if (!this.$tip) {
                this.$tip = $('<div class="tipsy"></div>').html('<div class="tipsy-arrow"></div><div class="tipsy-inner ' + this.options.tipsyClass + '"></div>');
            }
            return this.$tip;
        },
